...
Üzgünüz, aradığınız sayfayı bulamıyoruz. Gidip bir göz atabilirsin.
...
Sizi gideceğiniz yere yönlendirmeye çalıştık, ancak iyi bir sonuç bulamadık. 
...
{% for item in site.posts %}
  ...
  {
    console.log("Postalar içinde bulundu");
    gonnaFwd = true;
    archive = true;
